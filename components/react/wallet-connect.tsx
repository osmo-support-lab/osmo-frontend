...
export const ConnectWalletButton = ({
  ...
  return (
    <Button
      ...
      bgGradient="linear-gradient(109.6deg, osl.purple.900 11.2%, osl.orange.600 83.1%)"
      color="white"
      opacity={1}
      transition="all 0.5s ease-in-out"
      _hover={{
        bgGradient:
          'linear-gradient(270.6deg, osl.purple.900 11.2%, osl.orange.600 83.1%)',
        opacity: 0.80
      }}
      _active={{
        bgGradient:
          'linear-gradient(90.6deg, osl.lite-blue.900 11.2%, osl.orange.600 83.1%)',
        opacity: 0.9
      }}
